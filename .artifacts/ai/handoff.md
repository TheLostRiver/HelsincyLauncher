...
- Keep the current download job persistence behavior in `crates/adapter-storage-sqlite/src/lib.rs` unchanged; this slice only adds the `SqliteDownloadJobRepository` declaration comments.
