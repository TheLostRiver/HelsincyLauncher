...
- Keep the current projection/detail placeholder behavior in `crates/adapter-storage-sqlite/src/lib.rs` unchanged; this slice only adds the `SqliteFabMediaMetadataRepository` declaration comments.
