...
- The next natural missing-comment candidate is `crates/module-downloads/src/facade/mod.rs`, because that nearby backend boundary still contains uncommented declarations while its existing comment blocks are already acceptable.
