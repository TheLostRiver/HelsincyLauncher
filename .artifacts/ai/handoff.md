...
- The next natural old-English-comment rewrite candidate is `crates/module-downloads/src/contracts/commands.rs`, because it is the next adjacent downloads contracts file whose declaration comments are still English.
