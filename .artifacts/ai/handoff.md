...
- status: committed locally as `1397ec7`
...
- Unrelated unstaged/unknown work remains present and must not be committed with AT-2026-05-15-153:
  - `Cargo.lock`
  - `MyEpicLauncher.pen`
...
1. Validate and commit AT-2026-05-15-153 as a record-only docs-first design boundary task.
2. Before editing Rust for `resume_download`, present the checkpoint-aware design and get approval.
