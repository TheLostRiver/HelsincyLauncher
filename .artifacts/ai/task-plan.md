...
- AT-2026-05-08-098 has now completed the next missing-comment-only slice by documenting the shared foundation error contract in `crates/kernel-foundation/src/error.rs`.
