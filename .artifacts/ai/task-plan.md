...
- AT-2026-05-06-087 has now completed the next missing-comment-only slice by documenting the public event union and variants in `crates/module-fab/src/contracts/events.rs`.
