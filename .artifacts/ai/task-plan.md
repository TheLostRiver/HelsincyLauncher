...
- AT-2026-05-08-105 has now completed the next missing-comment-only slice by documenting the shared jobs crate entry boundary in `crates/kernel-jobs/src/lib.rs`.
