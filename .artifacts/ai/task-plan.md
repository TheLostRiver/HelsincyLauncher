...
- Use the validated `launcher-adapter-provider-fab` shell as the second adapter boundary baseline.
...
2. After AT-2026-05-03-026 passes, persist the new `Cargo.lock` delta before moving on to the next slice.
