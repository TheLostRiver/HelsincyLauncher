...
203. AT-2026-05-17-209 - validating - documented the downloads policy SQLite persistence boundary before Rust coding, keeping runtime policy application, global settings, transport, frontend, concrete IO, retry/backoff, and terminal completion out of scope.
